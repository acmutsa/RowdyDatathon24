...
CREATE TABLE `registration_data` (
	...
	`accepted_mlh_code_of_conduct` integer DEFAULT false NOT NULL,
	`shared_data_with_mlh` integer DEFAULT false NOT NULL,
	`wants_to_receive_mlh_emails` integer DEFAULT false NOT NULL,
